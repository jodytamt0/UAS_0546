...
--
-- Table structure for table `tbl_students_0546`
--

CREATE TABLE `tbl_students_0546` (
  `id` int(15) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0546`
--

INSERT INTO `tbl_students_0546` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0546`
--
ALTER TABLE `tbl_students_0546`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0546`
--
ALTER TABLE `tbl_students_0546`
